...
public class SmeltGUI implements InventoryProvider {

    public static final SmartInventory SMELT_ORES = SmartInventory.builder()
            .id("smeltGUI")
            .provider(new SmeltGUI())
            .size(2, 9)
    ...
    public void init(Player player, InventoryContents contents) {
        ...
        contents.set(0, 4, ClickableItem.of
                (GUIItem.dispItem(Material.FURNACE, ChatColor.YELLOW, "Furnace",
                        ChatColor.GRAY + "Click an item to smelt it!\n"
                        + ChatColor.DARK_GRAY + "Click here to return to the furnace"),
                        e -> {
                            player.playSound(player.getLocation(), Sound.UI_BUTTON_CLICK, 0.5f, 1);
                            FurnaceGUI.FURNACE_GUI.open(player);
                        }));
