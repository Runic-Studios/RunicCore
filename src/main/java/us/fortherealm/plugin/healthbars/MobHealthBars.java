...
import us.fortherealm.plugin.utilities.InvisStandSpawner;
...
public final class MobHealthBars implements Listener {
    ...
    private void setupMob(LivingEntity mob, boolean isVanilla) {
        ...
        stand.setSmall(true);
        stand.setMetadata("healthbar", new FixedMetadataValue(FTRCore.getInstance(), "healthbar"));
        ...
        if (isVanilla) {
            ...
            stand2.setMetadata("healthbar", new FixedMetadataValue(FTRCore.getInstance(), "healthbar"));
