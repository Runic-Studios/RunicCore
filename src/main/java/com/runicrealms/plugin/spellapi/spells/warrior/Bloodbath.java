 ...
 * @author BoBoBalloon
 */
public class Bloodbath extends Spell {
    ...
    protected void loadSpellSpecificData(Map<String, Object> spellData) {
        ...
        Number healingPerStrength = (Number) spellData.getOrDefault("healing-multiplier", 0.1);
        this.healingPerStrength = healingPerStrength.doubleValue();
