...
public class SpellScalingListener implements Listener {
    ...
    public void onPhysicalDamage(PhysicalDamageEvent event) {
        ...
        event.setAmount((int) (event.getAmount() + (((PhysicalDamageSpell) event.getSpell()).getPhysicalDamagePerLevel() * event.getPlayer().getLevel())));
    }
    ...
    public void onSpellDamage(MagicDamageEvent event) {
        ...
        event.setAmount((int) (event.getAmount() + (((MagicDamageSpell) event.getSpell()).getMagicDamagePerLevel() * event.getPlayer().getLevel())));
    }
