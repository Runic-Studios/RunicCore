...
import com.runicrealms.plugin.spellapi.spells.cleric.HealingSprite;
...
import com.runicrealms.plugin.spellapi.spells.warrior.SacredWings;
...
public class SpellManager implements Listener, SpellAPI {
    ...
    private void registerSpells() {
        ...
        this.spellList.add(new HealingSprite());
        ...
        this.spellList.add(new Wildfire());
        ...
        this.spellList.add(new Glacier());
        ...
        this.spellList.add(new Incendiary());
