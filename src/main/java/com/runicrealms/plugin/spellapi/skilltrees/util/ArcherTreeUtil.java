...
public class ArcherTreeUtil {
    ...
    public static List<Perk> marksmanPerkList() {
        ...
        perks.add(new PerkBaseStat(1, 1, 0, 5, Stat.DEXTERITY));
        perks.add(new PerkSpell(2, 1, 0, 1, "Hawkeye"));
        perks.add(new PerkBaseStat(3, 1, 0, 3, Stat.INTELLIGENCE));
        perks.add(new PerkBaseStat(4, 1, 0, 3, Stat.DEXTERITY));
    ...
    public static List<Perk> scoutPerkList() {
        ...
        perks.add(new PerkBaseStat(13, 1, 0, 5, Stat.DEXTERITY));
        perks.add(new PerkSpell(14, 1, 0, 1, "Wing Clip"));
        perks.add(new PerkBaseStat(15, 1, 0, 3, Stat.INTELLIGENCE));
        perks.add(new PerkBaseStat(16, 1, 0, 3, Stat.DEXTERITY));
    ...
    public static List<Perk> wardenPerkList() {
        ...
        perks.add(new PerkBaseStat(25, 1, 0, 5, Stat.DEXTERITY));
        perks.add(new PerkSpell(26, 1, 0, 1, "Icebrand"));
        perks.add(new PerkBaseStat(27, 1, 0, 3, Stat.VITALITY));
        perks.add(new PerkBaseStat(28, 1, 0, 3, Stat.DEXTERITY));
