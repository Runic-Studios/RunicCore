...
public class RogueTreeUtil {
    ...
    public static List<Perk> assassinPerkList() {
        ...
        perks.add(new PerkBaseStat(109, 1, 0, 5, BaseStatEnum.STRENGTH, 1));
        perks.add(new PerkSpell(110, 1, 0, 1, "Backstab"));
        perks.add(new PerkBaseStat(111, 1, 0, 3, BaseStatEnum.DEXTERITY, 1));
        perks.add(new PerkBaseStat(112, 1, 0, 3, BaseStatEnum.STRENGTH, 1));
        perks.add(new PerkSpell(113, 1, 0, 1, "Cloak"));
        perks.add(new PerkBaseStat(114, 1, 0, 3, BaseStatEnum.STRENGTH, 1));
        perks.add(new PerkBaseStat(115, 1, 0, 3, BaseStatEnum.DEXTERITY, 1));
        perks.add(new PerkBaseStat(117, 1, 0, 5, BaseStatEnum.STRENGTH, 1));
        perks.add(new PerkSpell(116, 1, 0, 1, "Slice and Dice"));
        perks.add(new PerkBaseStat(118, 1, 0, 3, BaseStatEnum.STRENGTH, 1));
    ...
    public static List<Perk> swindlerPerkList() {
        ...
        perks.add(new PerkBaseStat(133, 1, 0, 5, BaseStatEnum.STRENGTH, 1));
        perks.add(new PerkSpell(134, 1, 0, 1, "Agility"));
        perks.add(new PerkBaseStat(135, 1, 0, 3, BaseStatEnum.DEXTERITY, 1));
        perks.add(new PerkBaseStat(136, 1, 0, 3, BaseStatEnum.STRENGTH, 1));
        perks.add(new PerkSpell(137, 1, 0, 1, "Harpoon"));
        perks.add(new PerkBaseStat(138, 1, 0, 3, BaseStatEnum.DEXTERITY, 1));
        perks.add(new PerkBaseStat(139, 1, 0, 3, BaseStatEnum.STRENGTH, 1));
        perks.add(new PerkBaseStat(141, 1, 0, 5, BaseStatEnum.DEXTERITY, 1));
        perks.add(new PerkSpell(140, 1, 0, 1, "Twist of Fate"));
        perks.add(new PerkBaseStat(142, 1, 0, 3, BaseStatEnum.STRENGTH, 1));
