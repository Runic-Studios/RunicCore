...
public class WarriorTreeUtil {
    ...
    public static List<Perk> berserkerPerkList() {
        ...
        perks.add(new PerkSpell(144, 1, 0, 1, "Enrage")); // should also damage mobs
    ...
    public static List<Perk> guardianPerkList() {
        List<Perk> perks = new ArrayList<>();
        perks.add(new PerkSpell(156, 1, 0, 1, "Reflect")); // buff a lot
        ...
        perks.add(new PerkSpell(161, 1, 0, 1, "Divine Shield"));
