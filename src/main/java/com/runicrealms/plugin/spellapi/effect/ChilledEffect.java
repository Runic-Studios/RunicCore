...
public class ChilledEffect implements SpellEffect {
     ...
     */
    public ChilledEffect(Player caster, LivingEntity recipient, double duration) {
        this.caster = caster;
    ...
    public SpellEffectType getEffectType() {
        return SpellEffectType.CHILLED;
    }
