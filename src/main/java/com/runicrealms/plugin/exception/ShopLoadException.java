package com.runicrealms.plugin.exception;
...
public class ShopLoadException extends Exception {
    ...
    public ShopLoadException(String... messages) {
    ...
    public void displayToOnlinePlayers() {
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            if (this.error != null) {
                player.sendMessage(ChatColor.RED + "Check the console for a detailed ShopLoadException error trace.");
            }
        }
    }
    ...
    public ShopLoadException setErrorMessage(String message) {
        error = message;
        return this;
    }
