package com.runicrealms.plugin.skillapi;

import com.runicrealms.plugin.skillapi.skilltypes.Skill;
import com.runicrealms.plugin.RunicCore;
import com.runicrealms.plugin.skillapi.skills.archer.*;
import com.runicrealms.plugin.skillapi.skills.cleric.*;
import com.runicrealms.plugin.skillapi.skills.mage.*;
import com.runicrealms.plugin.skillapi.skills.rogue.*;
import com.runicrealms.plugin.skillapi.skills.runic.*;
import com.runicrealms.plugin.skillapi.skills.warrior.*;
...
public class SkillManager {
    ...
    public void addCooldown(final Player player, final Skill skill, double cooldownTime) {
        ...
        plugin.getServer().getScheduler().runTaskLaterAsynchronously(plugin, () -> SkillManager.this.removeCooldown(player, skill), (long) cooldownTime * 20);
    ...
    private void registerSkills() {
        ...
        this.skillList.add(new Judgement());
        ...
        this.skillList.add(new BlessedRain());
    }
